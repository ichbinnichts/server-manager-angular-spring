...
public class ServerServiceImpl implements ServerService {
    ...
    private String setServerImageUrl() {
        String[] imageNames = {"server.png", "server2.png"};
        return ServletUriComponentsBuilder.fromCurrentContextPath().path("/server/img/" + imageNames[new Random().nextInt(2)]).toUriString();
    }
}
